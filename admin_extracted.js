    ...
    <script>
        ...
        window.showSection = function (id, btn) {
            ...
            const titles = { overview: 'Dashboard', leaderboard: 'Top Performers', students: 'All Students', staff: 'Staff Management', tests: 'Tests', examschedule: 'Exam Schedule', results: 'Results', announcements: 'Broadcast Center', malpractice: 'Malpractice Logs', feedback: 'Feedback / Complaints', adminmgmt: 'Admin Management' };
